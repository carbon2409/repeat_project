...
from .views import CreateOrderView, SuccessOrderView, CancelOrderView, OrderListView, OrderDetailView, UpdateOrderView

app_name = 'orders_app'

urlpatterns = [
    path('create/', CreateOrderView.as_view(), name='create_order_url'),
    path('update/<int:pk>/', UpdateOrderView.as_view(), name='update_order_url'),
